...
import i18n from '@ringcentral-integration/engage-voice-widgets/components/SessionConfigPanel/i18n';
import styles from '@ringcentral-integration/engage-voice-widgets/components/SessionConfigPanel/styles.scss';
