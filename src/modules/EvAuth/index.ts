...
import { loginStatus, messageTypes, tabManagerEvents } from '@ringcentral-integration/engage-voice-widgets/enums';
import type { EvAgentConfig, EvAgentData } from '@ringcentral-integration/engage-voice-widgets/lib/EvClient';
...
import { sortByName } from '@ringcentral-integration/engage-voice-widgets/lib/sortByName';
...
import type {
  ...
  Deps,
  State,
} from '@ringcentral-integration/engage-voice-widgets/modules/EvAuth/EvAuth.interface';
import i18n from '@ringcentral-integration/engage-voice-widgets/modules/EvAuth/i18n';
    ...
    if (event) {
      switch (event.name) {
        case tabManagerEvents.LOGOUT:
          ...
          this._deps.evClient.closeSocket(); // Clear current connection
          break;
