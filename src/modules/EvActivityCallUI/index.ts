...
import type { EvTransferType, MessageTypes } from '@ringcentral-integration/engage-voice-widgets/enums';
import {
  dialoutStatuses,
  logTypes,
  messageTypes,
...
import type { EvBaggage } from '@ringcentral-integration/engage-voice-widgets/lib/EvClient';
import type { ActivityCallUI } from '@ringcentral-integration/engage-voice-widgets/modules/EvActivityCallUI/EvActivityCallUI.interface';
  ...
  implements ActivityCallUI
{
  ...
  constructor(deps: T) {
    super({
      deps,
      enableCache: false, // NO to share state to other tab
    ...
    return {
      ...
      call: {
        ...
        from: {
          ...
          name: callType !== 'OUTBOUND' ? name : fromNumber,
        },
        to: {
          phoneNumber: toNumber,
          name: callType === 'OUTBOUND' ? name : toNumber,
        },
        ...
        toMatches: [],
        activityMatches: [],
        recordingUrl: currentCall?.session?.recordingUrl,
      },
