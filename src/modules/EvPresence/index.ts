...
import type { DialoutStatusesType } from '@ringcentral-integration/engage-voice-widgets/enums';
import { dialoutStatuses, messageTypes } from '@ringcentral-integration/engage-voice-widgets/enums';
...
import type { Deps, Presence } from '@ringcentral-integration/engage-voice-widgets/modules/EvPresence/EvPresence.interface';
    ...
    this._deps.evSubscription
      ...
      .subscribe(
        ...
        (data: EvOffhookTermResponse) => {
          // Fix wrong alert message when logout
