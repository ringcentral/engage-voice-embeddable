...
export default {
  ...
  [messageTypes.INTERCEPT]: 'O resultado da marcação da sua chamada de saída manual foi INTERCEPT.',
  [messageTypes.COPY_UII_SUCCESS]: 'ID de chamada copiado',
  [callErrors.noToNumber]: 'Introduza um número de telefone válido.',
  [callErrors.emergencyNumber]: 'As chamadas de emergência não estão disponíveis.',
} as const;
