...
export default {
  [EvAlertMessageTypes.NO_AGENT]: 'This RC account has not been assigned any EV agent account. Please contact your admin or supervisor.',
  [EvAlertMessageTypes.CONNECT_ERROR]: 'Authentication error. Please retry later.',
  [EvAlertMessageTypes.UNEXPECTED_AGENT]: 'This RC account has been assigned an unexpected EV agent account. Please contact your admin or supervisor.',
  ...
  [EvAlertMessageTypes.MICROPHONE_ACCESS_DENIED]: 'Microphone access denied. Please enable microphone permissions.',
} as const;
